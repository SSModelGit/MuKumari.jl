...
obcs = let obcs = [];
    push!(obcs, Dict(:poly => [(0., 0.), (0., 0.5), (0.4, 0.3), (0.5, 0.)], :risk => 3., :impact => 10.));
    push!(obcs, Dict(:poly => [(4., 4.5), (5., 4.5), (7., 5.), (2, 5.)], :risk => 3., :impact => 10.));
end

goal = Dict(:target=>[9.5 9.5], :strength=>100., :influence=>30., :size=>0.5)
