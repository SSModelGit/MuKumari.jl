...
struct GPAgent
    ...
    planner::Function          # Optional control policy
end

function init_gpagent(name::String, start::Vector{Float64}, E::Int; r_comm=2.0)
    return GPAgent(name, start, zeros(E, E), zeros(E), 1, r_comm, x->x)
end
